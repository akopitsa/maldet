...
1. [Setup - The basics of getting started with maldet](#setup)
    * [What maldet affects](#what-maldet-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with maldet](#beginning-with-maldet)
